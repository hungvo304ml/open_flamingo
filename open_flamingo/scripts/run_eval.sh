...
# srun --cpu_bind=v --accel-bind=gn python /home/hqvo2/Projects/MultiMEDal_multimodal_medical/libs/open_flamingo/open_flamingo/eval/evaluate.py \
...
PYTHONPATH="$PYTHONPATH:open_flamingo", torchrun --nnodes=1 --nproc_per_node=4 /home/hqvo2/Projects/MultiMEDal_multimodal_medical/libs/open_flamingo/open_flamingo/eval/evaluate.py \
    --vision_encoder_path ViT-L-14 \
    --vision_encoder_pretrained openai\
    --lm_path anas-awadalla/mpt-1b-redpajama-200b \
    --lm_tokenizer_path anas-awadalla/mpt-1b-redpajama-200b \
    --cross_attn_every_n_layers 1 \
    --checkpoint_path "/home/hqvo2/.cache/huggingface/hub/models--openflamingo--OpenFlamingo-3B-vitl-mpt1b/snapshots/ed3a0c3190b2fc2d1c39630738896d4e73ce1bbc/checkpoint.pt" \
    --results_file "results.json" \
    --precision fp32 \
    --batch_size 2 \
    --eval_hateful_memes \
    --hateful_memes_image_dir_path "/project/hnguyen2/hqvo2/Projects/Datasets/all_original_data/facebook-hateful-meme/data/img" \
    --hateful_memes_train_annotations_json_path "/project/hnguyen2/hqvo2/Projects/Datasets/all_original_data/facebook-hateful-meme/data/train.jsonl" \
    --hateful_memes_test_annotations_json_path "/project/hnguyen2/hqvo2/Projects/Datasets/all_original_data/facebook-hateful-meme/data/dev.jsonl"
